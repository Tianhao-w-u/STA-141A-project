...
```
The test accuracy is 0.8%(The model correctly predicts the class in 80% of cases.), which is a good improvement of our model. The AUC is 0.9234, which indicates that the model has strong ability to predict the values of feedback_type.
